...
class PostListAdapter(private val onItemClicked: (TrainingPost) -> Unit) :
    ...
    inner class MyViewHolder(val binding: TrainerPostLayoutBinding, onItemClicked: (Int) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            TrainerPostLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        ) {
